...
const CartDrawer = ({ isOpen, onClose }) => {
  ...
  return (
    <>
      ...
      <div
        className={`fixed top-0 right-0 h-full w-full sm:w-[400px] bg-white z-[200] shadow-2xl transform transition-transform duration-300 ease-in-out ${
      ...
      >
        ...
        <div className="absolute bottom-0 left-0 w-full p-4 bg-white border-t">
          ...
          <button className="w-full bg-primary text-white py-3 font-bold uppercase tracking-widest hover:bg-pink-700 transition-colors">
            Checkout
          </button>
        </div>
      </div>
